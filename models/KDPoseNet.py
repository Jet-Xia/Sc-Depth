...
class KDPoseNet(nn.Module):

    def __init__(self, pretrained=True):
        super(KDPoseNet, self).__init__()
        self.encoder = MobilenetEncoder(pretrained=pretrained, num_input_images=2)
    ...
    def forward(self, img1, img2):
        ...
        pose = self.decoder([features])    # [B, 6]
        return pose
