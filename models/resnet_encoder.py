...
def resnet_multiimage_input(num_layers, pretrained=False, num_input_images=1):
    ...
    if pretrained:
        weight_url = {18: models.ResNet18_Weights.IMAGENET1K_V1.url,
                      50: models.ResNet50_Weights.IMAGENET1K_V1.url}[num_layers]
        loaded = torch.hub.load_state_dict_from_url(weight_url)
